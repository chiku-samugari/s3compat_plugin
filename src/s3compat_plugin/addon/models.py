...
from .typedmodel_workaround import TypedModelRegistrationMixin


class S3CompatFileNode(TypedModelRegistrationMixin, BaseFileNode):
    """
    ...
    The class applied TypedModelRegistrationMixin reenters to the
    TypedModel's registry, even if that class is directly specified to
    be a proxy class.
    """
    _provider = 's3compat'
...
class NodeSettings(BaseOAuthNodeSettings, BaseStorageAddon):
    ...
    # external_account_host # might be needed...
